    ...
    return (
      <div className="min-h-screen flex items-center justify-center px-6">
        <div className="text-center">
          ...
          <Link href="/catalog" className="text-primary hover:text-primary-dark font-medium">
            Browse the general catalog
          </Link>
        </div>
      </div>
    );
    ...
    <div className="min-h-screen">
      ...
      <main className="max-w-6xl mx-auto px-6 py-8">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-2xl font-bold mb-2">Approved EdTech Tools</h1>
          <p className="text-sm text-muted">
            These tools have been reviewed and approved for use in {districtName}.
          </p>
        </div>
